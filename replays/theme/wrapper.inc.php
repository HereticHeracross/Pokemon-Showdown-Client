...
<?php $panels->scripts(); ?>
	...
	<script src="//play.pokemonshowdown.com/config/config.js?27edbb20"></script>
	<script src="//play.pokemonshowdown.com/js/battledata.js?1e44efb2"></script>
	<script src="//play.pokemonshowdown.com/data/pokedex-mini.js?0.35686886720091926"></script>
	<script src="//play.pokemonshowdown.com/data/pokedex-mini-bw.js?0.5505702148962683"></script>
